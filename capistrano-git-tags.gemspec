Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG.rdoc", "lib/capistrano/git/tags.rb", "lib/capistrano/git/release_notes.rb", "lib/capistrano/git/notifier.rb", "MIT-LICENSE", "README.markdown", "Manifest"]
